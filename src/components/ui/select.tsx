...
>(({ className, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Label
      ref={ref}
      className={cn("py-1.5 text-sm font-semibold", isRTL ? "pr-8 pl-2" : "pl-8 pr-2", className)}
      {...props}
    />
  );
});
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <span className={`absolute ${isRTL ? 'right-2' : 'left-2'} flex h-3.5 w-3.5 items-center justify-center`}>
